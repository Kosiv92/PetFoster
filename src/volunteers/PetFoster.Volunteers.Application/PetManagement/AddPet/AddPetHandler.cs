...
namespace PetFoster.Volunteers.Application.PetManagement.AddPet
{
    public sealed class AddPetHandler : ICommandHandler<Guid, AddPetCommand>
    {
        ...
        public AddPetHandler(ILogger<AddPetHandler> logger,
            IValidator<AddPetCommand> validator, ISpeciesContract speciesContract,
            IRepository<Volunteer, VolunteerId> volunteerRepository, [FromKeyedServices("volunteers")]  IUnitOfWork unitOfWork)
        {
            _logger = logger;
